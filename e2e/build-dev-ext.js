...
(function () {
  ...
  function isSubtitleImageVisible() {
    try {
      var v = findVideo(); if (!v) return false;
      var vr = v.getBoundingClientRect(); if (!vr.width || !vr.height) return false;
      ...
      for (var i = 0; i < imgs.length; i++) {
        ...
        if (cs.visibility === 'visible' && cs.display !== 'none' && parseFloat(cs.opacity || '1') > 0.1) return true;
      }
      return false;
